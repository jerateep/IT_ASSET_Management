...
{
    public partial class frmModelMonitor : Form
    {
        string strModelID_m;
        ...
        public frmModelMonitor()
        {
            InitializeComponent();
        }

        private void frmModelMonitor_Load(object sender, EventArgs e)
        {
            LoadData();
            LoadType();
        }
        ...
        private void GridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try//ดักerror
            {
                txtModelID_m.Text = GridView.CurrentRow.Cells[0].Value.ToString();
                txtModelName_m.Text = GridView.CurrentRow.Cells[1].Value.ToString();
                cbTypeName_m.Text = GridView.CurrentRow.Cells[2].Value.ToString();
            }
            catch (Exception)
            {
